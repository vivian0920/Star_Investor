...
import styles from './SubscribedStarInvestorBlockStyle';

const useStyle = makeStyles(styles);

const SubscribedStarInvestorBlock = ({ user }) => {
        ...
        <PaperBlock className={classes.root}>
            ...
            >
                ...
                <div className={classes.content}>
                    <Typography variant='h3'>{user.nick_name}</Typography>
...
export default SubscribedStarInvestorBlock;
