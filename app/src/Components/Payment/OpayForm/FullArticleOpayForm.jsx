...
const FullArticleOpayForm = ({ paymentInfo, id }) => {
        const data = {
                TradeDesc: "訂閱費用",
                PaymentType: "aio",
                ...
                ItemName: `${paymentInfo.nick_name}明星投資者文章吃到飽訂閱費`,
                TotalAmount: paymentInfo.subAllPost_price,
...
export default FullArticleOpayForm;