...
const SinglePostOpayForm = ({ paymentInfo, postId }) => {
        const data = {
                TradeDesc: "訂閱費用",
                PaymentType: "aio",
                ...
                ClientBackURL: `http://localhost:3000/star-investor-details/${postId}`,
                ItemName: `${paymentInfo.title}訂閱費`,
...
export default SinglePostOpayForm;