...
//監聽分享帳號
const ListeningSubscribeShareAccount = (contractAddress,web3) => {

    var contractInstance = new web3.eth.Contract(PublicInvestmentDataSharingPlatform.abi, contractAddress);

    //監聽某事件
    contractInstance.events.shareSecuritiesAccountSubscribed({}, function (err, event) {
        console.log(err);
    })
...
export default ListeningSubscribeShareAccount;